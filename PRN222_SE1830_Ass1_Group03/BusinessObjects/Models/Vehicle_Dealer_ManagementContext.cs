...
public partial class Vehicle_Dealer_ManagementContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__dealers__3213E83F6EA72CB4");

            entity.ToTable("dealers");

            entity.HasIndex(e => e.Code, "UQ__dealers__357D4CF9AF695B63").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__orders__3213E83FD0233CAC");

            entity.ToTable("orders");

            entity.HasIndex(e => e.OrderNumber, "UQ__orders__730E34DF70A4AC38").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__order_hi__3213E83F106C6018");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__test_dri__3213E83F8C9A05E0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__users__3213E83F0152B868");

            entity.ToTable("users");

            entity.HasIndex(e => e.Email, "UQ__users__AB6E616475455A96").IsUnique();

            entity.HasIndex(e => e.Username, "UQ__users__F3DBC5725CDAFAE2").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__vehicles__3213E83F5CB7D8D6");
